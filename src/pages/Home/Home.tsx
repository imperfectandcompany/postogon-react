...
export class Home extends React.Component{
    ...
    render(){
        return(<motion.div
                transition={{ ease: "easeIn", duration: 2 }} animate="visible">
<div className="w-full"> 
                <div className="container relative flex flex-col items-center pt-12 pb-24 mx-auto mt-8 rounded-lg bg-gradient-to-r from-indigo-500 to-indigo-700 sm:pt-24 sm:pb-32 md:pb-48 lg:pb-56 xl:pb-64">
                    <svg className="absolute top-0 right-0 mt-2 mr-2 lg:mr-12 lg:mt-12" width="104px" height="95px" viewBox="0 0 104 95" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                    ...
                    <svg className="absolute bottom-0 left-0 mb-2 ml-2 lg:ml-12 lg:mb-12" width="104px" height="95px" viewBox="0 0 104 95" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                        <g id="Work-in-Progress" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" opacity="0.122837612">
                            ...
                            <div className="w-full md:w-1/3">
                                <div className="flex flex-col items-center justify-center fade-in">
                                    <div className="flex items-center mt-8">
                                        <div className="w-10 h-10 mr-3 rounded-full xl:w-20 lg:h-14 lg:w-14 xl:h-20">
                                            <img className="w-full h-full" src="https://postogon.com/lit/public_html/assets/avatars/avatar(1).png" alt=""/>
                                        </div>
                                        <div className="w-10 h-10 rounded-full xl:w-20 lg:h-14 lg:w-14 xl:h-20">
                                            <img className="w-full h-full" src="https://postogon.com/lit/public_html/assets/avatars/avatar(2).png" alt=""/>
                                        </div>
                                    </div>
                                    <div className="flex items-center mt-4">
                                        ...
                                        <div className="w-10 h-10 rounded-full xl:w-20 lg:h-14 lg:w-14 xl:h-20">
                                            <img className="w-full h-full" src="https://postogon.com/lit/public_html/assets/avatars/avatar(3).png" alt=""/>
                                        </div>
                                    </div>
                                    <div className="flex items-center mt-4">
                                        <div className="w-10 h-10 mr-3 rounded-full xl:w-20 lg:h-14 lg:w-14 xl:h-20">
