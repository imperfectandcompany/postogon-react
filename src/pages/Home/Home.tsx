    ...
    return (
      ...
      >
        <div className="w-full">
          <div className="container relative flex flex-col items-center pt-12 pb-24 mx-auto mt-8 md:rounded-lg bg-gradient-to-r from-indigo-500 to-indigo-700 sm:pt-24 sm:pb-32 md:pb-48 lg:pb-56 xl:pb-64">
            <svg
              className="absolute top-0 right-0 mt-2 mr-2 lg:mr-12 lg:mt-12"
              width="104px"
              height="95px"
              viewBox="0 0 104 95"
              version="1.1"
            ...
            <svg
              className="absolute bottom-0 left-0 mb-2 ml-2 lg:ml-12 lg:mb-12"
              width="104px"
              height="95px"
              viewBox="0 0 104 95"
              version="1.1"
            ...
            <div className="w-11/12 mb-5 sm:w-2/3 sm:mb-10">
              <div className="flex flex-col-reverse flex-wrap items-center md:flex-row">
                <div className="flex flex-col items-center justify-center w-full pt-4 pb-6 md:w-2/3 md:pb-0 md:pr-6 md:block md:pt-0">
                  <h1 className="text-xl font-black leading-tight text-center text-white slide-in-bottom-h1 md:text-2xl lg:text-4xl xl:text-5xl lg:w-10/12 md:text-left">
                    The Freedom to Be Yourself Online
                  </h1>
                  <Link to="/continue">
                    <button className="px-4 py-3 mt-5 text-sm font-bold text-indigo-700 bg-white rounded-lg slide-in-bottom-subtitle lg:mt-12 lg:py-4 lg:px-6 lg:text-lg xl:text-xl hover:opacity-90">
                      Enter the Space
                    </button>
                  </Link>
                </div>
                  ...
                  <div className="flex flex-col items-center justify-center fade-in">
                    <div className="flex items-center mt-8">
                      <div className="w-10 h-10 mr-3 rounded-full xl:w-20 lg:h-14 lg:w-14 xl:h-20">
                        <img
                          ...
                          src="https://postogon.com/lit/public_html/assets/avatars/avatar(1).png"
                          alt=""
                        />
                      </div>
                      <div className="w-10 h-10 rounded-full xl:w-20 lg:h-14 lg:w-14 xl:h-20">
                        <img
                          className="w-full h-full"
                          src="https://postogon.com/lit/public_html/assets/avatars/avatar(2).png"
                          alt=""
                        />
                      </div>
                    </div>
                    <div className="flex items-center mt-4">
                      ...
                      <div className="w-10 h-10 rounded-full xl:w-20 lg:h-14 lg:w-14 xl:h-20">
                        <img
                          className="w-full h-full"
                          src="https://postogon.com/lit/public_html/assets/avatars/avatar(3).png"
                          alt=""
                        />
                      </div>
                    </div>
